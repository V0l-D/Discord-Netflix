...
# Roadmap
- Fix resolution for ultra-wide ✅ (This is finally possible due the latest version of electron/castlabs)
- Add 1080p support ✅ (This is finally possible due the latest version of electron/castlabs)
- Remove clutter code ✅ 
- Make Netflix Party work again (asap)
- Make independent plugin for chrome and firefox
- Make option for disabling certain rich presence elements
- Improve user privacy by spoofing browser information ✅ 
- Fix the errors that are being shown in the output ✅ 
- Make github repo for Netflix-Party (a more updated version of it) (asap)
- Add the profile icons that still need to be added (will take a long time it's all manually)
- Make a list of upcoming features on the discord-netflix repo ✅
- Make a linux version of Discord-Netflix ✅
- Make a mac version of Discord-Netflix ✅
- Add commands to Discord bot & Improve Discord bot (asap)
- Add uptime check system for Netflix party & Discord bot server (asap)
- Updated dependencies to the latest possible version ✅
- Auto updating system (in the works right now)
- Extensive testing of avatars some seems like they are broken ✅
- Make wiki for creating the Linux version of Discord-Netflix ✅
- Make wiki for creating the Mac version of Discord-Netflix ✅
- Make wiki for creating the Windows version of Discord-Netflix ✅
- Setup a beta program
- Adjust package.json to new GitHub username ✅
- Make website ✅
- Publish website ✅
- Make website work on mobile ✅
- Make a updated version for Mac ✅
# Preview
